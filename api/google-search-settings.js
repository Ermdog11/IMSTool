// /api/google-search-settings — Google Programmable Search credentials
// (site-restricted mode) for the news scanner's second web-search pass
// (api/_google-search.js), alongside Brave (api/search-settings.js).
//
